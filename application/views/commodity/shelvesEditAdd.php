	...
	<form method="POST" action="./"enctype="multipart/form-data" />
		<div class="row">
			<table class="table table-condensed table-bordered table-hover table-striped">
				...
				<tr class="info">
					<td><?php echo $lang->line('commodity_item_image'); ?></td>
					<td>
				...
				<tr class="info">
					...
					<td><textarea name="item_content" rows="5"><?php echo $itemList->item_content;?></textarea></td>
				</tr>		
				<tr class="info">
					<td><?php echo $lang->line('commodity_item_fulltext'); ?></td>
					<td><textarea class="ckeditor" cols="80" id="editor1" name="item_fulltext" rows="10"><?php echo $itemList -> fulltext;?></textarea></td>
				</tr>					
			</table>
