<article>
	<table class="table table-condensed table-bordered table-hover table-striped">
		...
		<tr class="info">
			<td class="items">
				<a href="/dealer/commodity/breadEdit/<?php echo $row->id;?>/"><img src="/dealer/statics/img/ic_action_edit.png"/></a>
				<a href="<?php echo $row->id;?>" class="breadDel"><img src="/dealer/statics/img/ic_action_remove.png"/></a>
			</td>
